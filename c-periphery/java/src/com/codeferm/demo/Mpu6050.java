...
public class Mpu6050 {
	 ...
	 */
	public double getTemp(final I2c i2c, final Peripheryi2cLibrary.i2c_t handle, final short addr) {
	 ...
	 */
	public void setAccelRange(final I2c i2c, final Peripheryi2cLibrary.i2c_t handle, final short addr, final short range) {
	 ...
	 */
	public short readAccelRange(final I2c i2c, final Peripheryi2cLibrary.i2c_t handle, final short addr, final boolean raw) {
		// Get the raw value
	 ...
	 */
	public Map<String, Double> getAccelData(final I2c i2c, final Peripheryi2cLibrary.i2c_t handle, final short addr, final boolean g) {
	 ...
	 */
	public void setGyroRange(final I2c i2c, final Peripheryi2cLibrary.i2c_t handle, final short addr, final short range) {
		// First change it to 0x00 to make sure we write the correct value later
	 ...
	 * @return
	 */
	public short readGyroRange(final I2c i2c, final Peripheryi2cLibrary.i2c_t handle, final short addr, final boolean raw) {
		// Get the raw value
	 ...
	 * @return Map of values.
	 */
	public Map<String, Double> getGyroData(final I2c i2c, final Peripheryi2cLibrary.i2c_t handle, final short addr) {
		// Read the data from the MPU-6050
