...
if [ "$arch" = "aarch64" ]; then
	...
	if [ ! -f libgpiod.jar ]; then
		...
		log "Compile library"
		cd ../ >> $logfile 2>&1
		javac -cp ../../jnaerator/jna-5.5.0.jar:../../jnaerator/jnaerator-runtime.jar gpiod/*.java >> $logfile 2>&1
		# Create package
...
javac -cp ../../jnaerator/jna-5.5.0.jar:../../jnaerator/jnaerator-runtime.jar:libgpiod.jar src/com/codeferm/demo/*.java >> $logfile 2>&1
